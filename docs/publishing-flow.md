...
```
# Default owners
* @rehamagentgram/maintainers

# Pipeline outputs (cannot be directly modified)
/src/content/articles/ @rehamagentgram/maintainers
/src/content/provenance/ @rehamagentgram/maintainers

# Workflow files
/.github/workflows/ @rehamagentgram/maintainers
```
